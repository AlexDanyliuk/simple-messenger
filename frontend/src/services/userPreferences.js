...
const translations = {
  uk: {
    ...
    forgotPasswordRequestCode: "Отримати код",
    forgotPasswordRequestSent: "Код відновлення згенеровано",
    forgotPasswordRequestFailed: "Не вдалося надіслати запит на відновлення",
    forgotPasswordDevCode: "Тестовий код",
    forgotPasswordCodePlaceholder: "6-значний код",
    forgotPasswordCodeRequired: "Введіть код відновлення",
    forgotPasswordCodeInvalid: "Код має містити 6 цифр",
    forgotPasswordNewPassword: "Новий пароль",
    forgotPasswordConfirmPassword: "Підтвердіть новий пароль",
    forgotPasswordSubmit: "Оновити пароль",
    forgotPasswordResetSuccess: "Пароль успішно змінено",
    forgotPasswordResetFailed: "Не вдалося змінити пароль",
    ...
    registerVerificationCodePlaceholder: "Код підтвердження з пошти",
    registerRequestCode: "Надіслати код",
    registerRequestCodeSent: "Код підтвердження надіслано на пошту",
    registerRequestCodeFailed: "Не вдалося надіслати код підтвердження",
    registerVerificationCodeRequired: "Введіть код підтвердження",
    registerVerificationCodeInvalid: "Код має містити 6 цифр",
  ...
  en: {
    ...
    forgotPasswordRequestCode: "Request code",
    forgotPasswordRequestSent: "Reset code generated",
    forgotPasswordRequestFailed: "Failed to request reset code",
    forgotPasswordDevCode: "Development code",
    forgotPasswordCodePlaceholder: "6-digit code",
    forgotPasswordCodeRequired: "Enter reset code",
    forgotPasswordCodeInvalid: "Code must contain 6 digits",
    forgotPasswordNewPassword: "New password",
    forgotPasswordConfirmPassword: "Confirm new password",
    forgotPasswordSubmit: "Update password",
    forgotPasswordResetSuccess: "Password changed successfully",
    forgotPasswordResetFailed: "Failed to reset password",
    ...
    registerVerificationCodePlaceholder: "Verification code from email",
    registerRequestCode: "Send code",
    registerRequestCodeSent: "Verification code sent to your email",
    registerRequestCodeFailed: "Failed to send verification code",
    registerVerificationCodeRequired: "Enter verification code",
    registerVerificationCodeInvalid: "Code must contain 6 digits",
    ...
    profileChangePasswordSubmit: "Change password",
